        ...
        <>
            ...
            <section className='flex flex-col mx-2'>
                <article className='mt-2'>
                    ...
                    <LinkSetter goto={'/mypage/myrecruitment'}
                    ...
                    />
                    <LinkSetter goto={'/mypage/myappointment'}
                    addedClassName={'flex items-center mx-4 mt-2'}
                ...
                <article className='mt-2'>
                    ...
                    <LinkSetter goto={'/mypage/profile'}
                    addedClassName={'flex items-center mx-4 mt-2'}
                    ...
                    />
                    <LinkSetter goto={'/mypage/undefined'}
                    addedClassName={'flex items-center mx-4 mt-2'}
                    ...
                    />
                    <LinkSetter goto={'/mypage/modifyinfo'}
                    addedClassName={'flex items-center mx-4 mt-2'}
